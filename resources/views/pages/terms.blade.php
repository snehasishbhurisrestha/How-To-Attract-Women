...
<head>
    ...
    <title>Terms & Conditions — HOW TO ATTRACT WOMEN</title>
    <link
    ...
    <style>
        ...
        *::after {
        ...
        .pp-sec-body ul.no-list li::before {
            content: '✕';
            color: var(--red)
        }
...
<body>
    ...
    <div class="pp-wrap">
        ...
        <div class="intro-card">
            <p>Welcome to our website. By accessing this website and purchasing our digital products, you agree to the
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">01</span>
                <div class="pp-sec-icon">📜</div>
                <div class="pp-sec-title">Acceptance of Terms</div>
            </div>
            <div class="pp-sec-body">
                <p>By using this website, you acknowledge that you have read, understood, and agreed to be bound by
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">02</span>
                <div class="pp-sec-icon">📦</div>
                <div class="pp-sec-title">Digital Product</div>
            </div>
            <div class="pp-sec-body">
                <p>The product offered on this website is a digital eBook intended for educational and informational
                    purposes only.</p>
                <p>After successful payment, customers will receive access to the digital product through the provided
                    delivery method.</p>
            </div>
        </div>
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">03</span>
                <div class="pp-sec-icon">©️</div>
                <div class="pp-sec-title">Intellectual Property</div>
            </div>
            <div class="pp-sec-body">
                <p>All content, including eBooks, text, graphics, images, logos, and other materials, is the property of
                    <strong>Rahul Mondal</strong> and is protected by applicable copyright laws.</p>
                <p>You may not:</p>
                <ul class="no-list">
                    <li>Resell the eBook</li>
                    <li>Share download links publicly</li>
                    <li>Copy or redistribute the content</li>
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">04</span>
                <div class="pp-sec-icon">👤</div>
                <div class="pp-sec-title">Personal Use Only</div>
            </div>
            <div class="pp-sec-body">
                <p>The purchased eBook is for <strong>personal use only</strong>.</p>
                <div class="note">Commercial use, resale, reproduction, or distribution without written permission is
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">05</span>
                <div class="pp-sec-icon">⚠️</div>
                <div class="pp-sec-title">No Guaranteed Results</div>
            </div>
            <div class="pp-sec-body">
                <p>The information provided in our eBook is based on educational content and personal development
                    principles.</p>
                <p>Results may vary from person to person depending on individual effort, circumstances, and
                    implementation.</p>
                <p>We do not guarantee any specific outcome, relationship result, social result, or personal success.
                </p>
            </div>
        </div>
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">06</span>
                <div class="pp-sec-icon">💳</div>
                <div class="pp-sec-title">Pricing &amp; Payments</div>
            </div>
            <div class="pp-sec-body">
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">07</span>
                <div class="pp-sec-icon">↩️</div>
                <div class="pp-sec-title">Refund Policy</div>
            </div>
            <div class="pp-sec-body">
                <p>Due to the nature of digital products, all sales are final.</p>
                <p>Once the product has been delivered or accessed, refunds, returns, or exchanges cannot be provided
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">08</span>
                <div class="pp-sec-icon">⚖️</div>
                <div class="pp-sec-title">Limitation of Liability</div>
            </div>
            <div class="pp-sec-body">
                <p>We shall not be held responsible for any direct, indirect, incidental, or consequential damages
                    arising from the use of our website or digital products.</p>
                <p>Users are responsible for their own decisions and actions.</p>
            </div>
        </div>
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">09</span>
                <div class="pp-sec-icon">🌐</div>
                <div class="pp-sec-title">Website Availability</div>
            </div>
            <div class="pp-sec-body">
                <p>We reserve the right to modify, suspend, or discontinue any part of the website or product at any
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">10</span>
                <div class="pp-sec-icon">🔒</div>
                <div class="pp-sec-title">Privacy</div>
            </div>
            <div class="pp-sec-body">
                <p>Your use of this website is also governed by our <a href="{{ route('privacy-policy') }}">Privacy Policy</a>.
                </p>
            </div>
        </div>
        ...
        <div class="pp-card">
            <div class="pp-sec-head">
                <span class="pp-sec-num">11</span>
                <div class="pp-sec-icon">📝</div>
                <div class="pp-sec-title">Changes to Terms</div>
            </div>
            <div class="pp-sec-body">
                <p>We reserve the right to update or modify these Terms &amp; Conditions at any time. Changes will be
        ...
        <div class="agreement-banner">
            ...
            <p>By using this website and purchasing our products, you agree to these Terms &amp; Conditions.</p>
        </div>

        <!-- CONTACT CTA -->
        <div class="contact-card">
            <h3>CONTACT INFORMATION</h3>
            <p>If you have any questions regarding these Terms &amp; Conditions, please contact <strong>Rahul
                    Mondal</strong>.</p>
