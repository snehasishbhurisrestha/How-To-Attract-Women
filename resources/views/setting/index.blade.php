...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0 text-white">Website Settings</h5>
        </div>
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="settingsTabs" role="tablist">
                {{-- <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#general" role="tab">General</a></li> --}}
                ...
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#scripts" role="tab">SEO Tags Manager</a></li>
